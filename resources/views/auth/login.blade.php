...
<body>
    ...
    <div class="wrapper">
        <!-- Login Section Start -->
        <div class="login--section pd--100-0 bg--overlay" data-bg-img="https://chobao.vn/wp-content/uploads/2023/02/VTV.jpg">
            <div class="container">
                <!-- Login Form Start -->
                <div class="login--form">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <p class="help-block clearfix">
                            ...
                            <a href="{{ url('/password/reset') }}" class="btn-link pull-left">Forgot Username or Password?</a>
