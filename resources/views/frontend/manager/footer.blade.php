...
CƠ QUAN BÁO CHÍ: BÁO ĐIỆN TỬ VTV NEWS</p>
                            </div>
                            ...
                            <ul class="nav">
                                <li>
                                    <i class="fa fa-map"></i>
                                    <span>43 Nguyễn Chí Thanh, Ba Đình, Hà Nội</span>
                                </li>
                                <li>
                                    <i class="fa fa-envelope-o"></i>
                                    <a href="mailto:example@example.com"> toasoan@vtv.vn</a>
                                </li>
                                <li>
                                    <i class="fa fa-phone"></i>
                                    <a href="tel:+123456789">(024) 3.8355931; (024) 3.8355932</a>
                                </li>
                            </ul>
                        </div>
                        <!-- About Widget End -->
    ...
    <div class="footer--copyright bg--color-3">
        ...
        <div class="container">
            <p class="text float--left">&copy; 2023 phát triển bởi <a href="#">VTV</a>. All Rights Reserved.</p>
